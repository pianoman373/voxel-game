...
function HudGUI:render(width, height)
    ...
    -- -- crosshair
    -- api.renderSpriteColor((width/2) - (crosshairLength/2), (height/2) - (crosshairThickness/2),	20.0, 3.0,	1.0, 1.0, 1.0, 1.0, 0.0)
    -- api.renderSpriteColor((width/2) - (crosshairThickness/2), (height/2) - (crosshairLength/2),	3.0, 20.0,	1.0, 1.0, 1.0, 1.0, 0.0)
    ...
    -- for i = 0, 11 do
    --     api.renderSpriteTexture(xOffset + (blockSize * i), 0,     blockSize, blockSize,           (1/8)*1, (1/8)*1, (1/8)*2, (1/8)*2,  img, 0.0)
    ...
    -- api.renderSpriteTexture(xOffset - (blockSize) + ((self.player.selectedSlot-1) * blockSize), -(blockSize),     blockSize*3, blockSize*3,           (1/8)*2, (1/8)*0, (1/8)*5, (1/8)*3,  img, 0.0)
end
